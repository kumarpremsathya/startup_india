...
def main():
    ...
    if startup_india_config.source_status == "Active":
        ...
        check_increment_data.check_increment_data(r"C:\Users\Premkumar.8265\Desktop\sui_test_incre - Copy\incremental_start_up_india\data\excel_sheet\final_excels_2024-10-14.xlsx")
