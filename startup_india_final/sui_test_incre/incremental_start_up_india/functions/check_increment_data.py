...
def check_increment_data(new_data_file):
    ...
    try:
        ...
        if len(deleted_pageurls) > 0:
            yes_or_no.update_deleted_rows_in_database(r"C:\Users\Premkumar.8265\Desktop\sui_test_incre\incremental_start_up_india\data\excel_sheet\final_excels_09_09_2024.xlsx")
